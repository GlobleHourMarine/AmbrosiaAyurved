...
class Order_model extends CI_Model
{
    ...
    public function fetch_order_data($userid, $limit, $offset)
    {
        ...
        $this->db->join('track_order', 'order_table.order_id = track_order.order_id', 'left');
        $this->db->where('track_order.user_id', $userid);
    ...
    //         product_table.product_name
    //     ');
    //     $this->db->from('track_order');
    //     $this->db->join('order_table', 'track_order.order_id = order_table.order_id', 'left');
    //     $this->db->join('product_table', 'order_table.product_id = product_table.product_id', 'left');
