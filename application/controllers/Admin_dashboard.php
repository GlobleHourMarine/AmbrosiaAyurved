...
class Admin_dashboard extends CI_Controller
{
    ...
    public function send_push_notification()
    {
        if($this->input->server('REQUEST_METHOD') === 'POST'){
            ...
            $res = $this->admin_model->send_message('notifications', $data);
            if($res)
            {
                $keyPath=realpath(APPPATH . '../firebaseKeys.json');
            ...
            $data['content'] = $this->load->view('Admin/push_notification.php', null, true);
            $this->load->view('Admin/admin_layout.php', $data);
        }
    }
