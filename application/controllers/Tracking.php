...
class Tracking extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->token = $this->session->userdata('shiprocket_token');
        $this->token_expiry = $this->session->userdata('shiprocket_token_expiry');
    ...
    public function auth_token()
    {
        ...
        if (isset($data['token'])) {
            ...
            $this->session->set_userdata('shiprocket_token', $data['token']);
            $this->session->set_userdata('shiprocket_token_expiry', time() + 864000);
    ...
    public function view_cart()
    {
        ...
        public function create_order($data = null)
        {
            ...
            //     file_put_contents(APPPATH . 'logs/verify.log', "product_data key is missing\n", FILE_APPEND);
            // } else {
            //     file_put_contents(APPPATH . 'logs/verify.log', "product_data raw: " . $data['product_data'] . "\n", FILE_APPEND);
            // }
