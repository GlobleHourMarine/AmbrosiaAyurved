...
class User extends CI_Controller
{
    ...
    public function userregister()
    {
        ...
        // ✅ Check if mobile and session ID are provided (means OTP verified)
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($check == 1) {
                ...
                if ($check_account_status == 'Deleted') {
                    ...
                    $this->usermodel->update_userdata_with_account_status('user_table', $email, $data);
...
// print_r($id);
    ...
    public function save_address()
    {
        ...
        $this->load->model('Usermodel');
        $result = $this->usermodel->save_address('user_address', $data);
