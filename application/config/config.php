...
// $config['sess_cookie_name'] = 'ci_session';
// $config['sess_expiration'] = 7200;
// $config['sess_save_path'] = 'ci_sessions'; // table name only
// $config['sess_match_ip'] = FALSE;
// $config['sess_time_to_update'] = 300;
// $config['sess_regenerate_destroy'] = FALSE;
...
$config['sess_cookie_name'] = 'ci_session';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = sys_get_temp_dir(); // Important: Must be writeable
$config['sess_match_ip'] = FALSE;
$config['sess_time_to_update'] = 300;
$config['sess_regenerate_destroy'] = FALSE;
/*
...
$config['csrf_exclude_uris'] = ['Tracking/create_order'];
...
$config['ship24_api_key'] = 'apik_0g7Ozznx0ct2owz9MiAQtbWP4TFz6M';


/**
 * PhonePe Credentials
 */
$config['client_id'] = 'SU2506031142531039239175';
$config['client_secret'] = '0f0dbd9d-0d6d-46c0-ba46-e85a4bc65b66';
$config['client_version'] = 1;
/**
 * End
 */

$config['cron_token'] = '2VEOVSKZ3GMUL8B6QS0T8HZ938Y9FP5P';
