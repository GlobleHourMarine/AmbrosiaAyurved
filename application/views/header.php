...
<body data-base-url="<?php echo base_url(); ?>">
    ...
    <div class="whatsapp-float">
        <a href="https://wa.me/918000057233" class="whatsapp-link" target="_blank">
            <i class="fab fa-whatsapp whatsapp-icon"></i>
            <span class="whatsapp-text">Chat with us</span>
        </a>
    </div>
    <!-- custom-whatsapp-redirect.html -->
    <!-- <div style="text-align: center; margin-top: 100px;">
        <img src="new_logo11.webp" alt="Logo" width="100">
        <h2>Chat with Ambrossia Ayurved</h2>
        <p>We’re here to help you with your health queries.</p>
        <a href="https://wa.me/919876543210?text=Hi%20I%20want%20to%20know%20more%20about%20your%20products" target="_blank" style="background-color: #25D366; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">
        ...
        <div class="container-fluid main main-header-nav">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav main-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url('our_products') ?>">
                    ...
                    <div class="modal-body-of-address p-3">
                        <div class="text-center mb-3">
                            ...
                            <h6 style="font-size: 0.9rem; font-weight: 600; margin-bottom: 0.2rem;">
                                <?= !empty($fname) ? htmlspecialchars($fname) . ' ' . htmlspecialchars($lname) : 'Guest' ?>
                            </h6>
                            <p style="font-size: 0.75rem; color: #6c757d; margin-bottom: 0;">
                                <?= !empty($email) ? htmlspecialchars($email) : 'Not logged in' ?>
                            </p>
                        </div>
        ...
        <div class="modal fade mobile-address-model" id="addAddressModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="false">
            <div class="modal-dialog modal-sm">
                <div class="modal-content-of-address" style="border-radius: 12px; border: none;">
                    ...
                    <!-- me Form -->
                    <div class="modal-body-of-address p-3">
                        <form id="addressForm-of-header">
                            <div class="row g-2 mb-2">
                                <div class="col-6">
                                    <input type="text" name="fname" class="form-control form-control-sm" placeholder="First Name*" required pattern="[A-Za-z\s]+" title="Only letters allowed" style="font-size: 0.8rem; border-radius: 6px;" />
                                </div>
                                <div class="col-6">
                                    <input type="text" name="lname" class="form-control form-control-sm" placeholder="Last Name*" required pattern="[A-Za-z\s]+" title="Only letters allowed" style="font-size: 0.8rem; border-radius: 6px;" />
                                </div>
                            </div>

                            <div class="mb-2">
                                <input type="tel" name="mobile" class="form-control form-control-sm" placeholder="Phone*" required pattern="[0-9]{10}" title="Enter 10-digit phone number" maxlength="10" style="font-size: 0.8rem; border-radius: 6px;" />
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="address_type" id="homeType" value="home" checked style="width: 14px; height: 14px;" />
                                    <label class="form-check-label" for="homeType" style="font-size: 0.8rem;">Home</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="address_type" id="workType" value="work" style="width: 14px; height: 14px;" />
    ...
    <div class="aa-offcanvas aa-offcanvas-end" tabindex="-1" id="aaCartDrawer" aria-labelledby="aaCartDrawerLabel">
        <div class="aa-offcanvas-header aa-border-bottom">
            <h5 class="aa-offcanvas-title" id="aaCartDrawerLabel"><i class="fas fa-shopping-cart me-2"></i> Your Cart</h5>
            <button type="button" class="aa-btn-close aa-text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>

        <div class="aa-offcanvas-body aa-p-0 aa-d-flex aa-flex-column">
            <!-- Cart Items Section -->
            <div id="aaCartItemsContainer" class="flex-grow-1"></div>

            <!-- Subtotal and Checkout Section -->
            <div class="aa-subtotal-section" style="display: none;">
                <div class="aa-offer-banner"><i class="fas fa-gift"></i> Hurry! Enjoy the best products</div>
                <div class="aa-subtotal-row">
                    <span>Estimated total</span>
                    <span id="aaCartTotal">₹0</span>
                </div>
                <a href="<?= base_url('order-summery') ?>" class="btn btn-success aa-checkout-btn">Checkout</a>
            </div>
        </div>
    </div>
 ...
 formData += '&user_id=' + encodeURIComponent(userId); 
            ...
            $.ajax({
                url: "<?= base_url('User/save_address') ?>", // Change to your actual controller/method
                type: "POST",
                data: formData,
                dataType: "json",
