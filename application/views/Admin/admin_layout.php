...
$permissions = $session_data['admin']['permissions'];
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="d-flex" id="wrapper">
        <div class="bg-dark text-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <?php if ($role == 'Admin' || in_array(5, $permissions)) : ?>
                ...
                <?php if ($role == 'Admin' || in_array(6, $permissions)) : ?>
                <!-- Orders Section -->
                ...
                <?php if ($role == 'Admin' || in_array(7, $permissions)) : ?>
                ...
                <?php if ($role == 'Admin' || in_array(8, $permissions)) : ?>
                ...
                <!-- Settings Section -->
                 <?php if ($role == 'Admin' || in_array(9, $permissions)) : ?>
                ...
                <?php if ($role == 'Admin' || in_array(10, $permissions)) : ?>
                ...
                <?php if ($role == 'Admin' || in_array(11, $permissions)) : ?>
                <a href="<?php echo base_url('enable-order-button'); ?>" class="list-group-item list-group-item-action">
                    <i class="fa-solid fa-icons"></i><span>Order Button</span>
                </a>
                <?php endif; ?>

                <?php if ($role == 'Admin' || in_array(12, $permissions)) : ?>
                <a href="<?php echo base_url('push-notification'); ?>" class="list-group-item list-group-item-action">
                    <i class="fa-solid fa-icons"></i><span>Push Notification</span>
                </a>
                <?php endif; ?>
