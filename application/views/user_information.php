                ...
                <div class="checkout-login-section">
                    ...
                    <div id="loginForm" style="display: none;">
                        <div class="checkout-form-group">
                            ...
                            <input type="phone" id="phone" name="phone" class="checkout-input" placeholder="Enter your number" />
                            <small id="emailError" class="checkout-error-message"></small>
                        </div>

                        <div class="checkout-form-group">
                            <label for="password" class="checkout-label">Password</label>
                            <input type="password" id="password" name="password" class="checkout-input" placeholder="Enter your password" />
                            <small id="passwordError" class="checkout-error-message"></small>
                            <div style="text-align: right; margin-top: 5px;">
                                <a href="<?= base_url('forgot_password') ?>" style="color: #3498db; font-size: 13px;">Forgot Password?</a>
                            </div>
                        </div>

                        <button id="verifyBtn" class="checkout-btn">Verify & Continue</button>
                    </div>
                </div>
            <?php endif; ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#verifyBtn").click(function() {
                ...
                $.ajax({
                    url: '<?= base_url("user/check_credentials") ?>',
                    type: 'POST',
                    data: {
                        phone: phone,
                        password: password
                    ...
                    `);
                            ...
                            // ❌ Invalid login — show OTP section for verification
                            $("#passwordError").text("Invalid credentials").css("color", "red");
            ...
            const userId = <?= json_encode($this->session->userdata('user_id')) ?>;
            $("#proceedToPaymentBtn").click(function() {
                console.log(userId);
                const selectedAddress = $(".checkout-address-card.selected input[name='selected_address']").val();
                if (selectedAddress) {
