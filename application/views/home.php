...
<?php endif; ?>
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" style="margin-top:30px; !important;">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <!-- Desktop/Tablet Image -->
            <img src="<?php echo base_url('/assets/images/S01.webp') ?>" loading="lazy" class="d-none d-md-block w-100" alt="carousel-image" />
            <!-- Mobile Image -->
            <img src="<?php echo base_url('/assets/images/phone01.webp') ?>" loading="lazy" class="d-block d-md-none w-100" alt="carousel-image" />
        </div>
        <div class="carousel-item">
            <img src="<?php echo base_url('/assets/images/S-2.webp') ?>" loading="lazy" class="d-none d-md-block w-100" alt="carousel-image" />
            <img src="<?php echo base_url('/assets/images/phone02.webp') ?>" loading="lazy" class="d-block d-md-none w-100" alt="carousel-image" />
        </div>
        <div class="carousel-item">
            <img src="<?php echo base_url('/assets/images/S003.webp') ?>" loading="lazy" class="d-none d-md-block w-100" alt="carousel-image" />
            <img src="<?php echo base_url('/assets/images/phone03.webp') ?>" loading="lazy" class="d-block d-md-none w-100" alt="carousel-image" />
        </div>
        <div class="carousel-item">
            <img src="<?php echo base_url('/assets/images/sli1.webp') ?>" loading="lazy" class="d-none d-md-block w-100" alt="carousel-image" />
            <img src="<?php echo base_url('/assets/images/phone04.webp') ?>" loading="lazy" class="d-block d-md-none w-100" alt="carousel-image" />
        </div>
        <div class="carousel-item">
            <img src="<?php echo base_url('/assets/images/S05.webp') ?>" loading="lazy" class="d-none d-md-block w-100" alt="carousel-image" />
            <img src="<?php echo base_url('/assets/images/phone5.webp') ?>" loading="lazy" class="d-block d-md-none w-100" alt="carousel-image" />
        </div>
    </div>
...
<!-- </div>  -->
<div class="product-container1" style="background-color: smokewhite; margin-top: 0px;">
    <div class="texttt" style="margin-bottom: 25px;">
        <p class="target-pharagraph" style="text-align: left;">
            A5 Herbal Supplement isn’t just another Ayurvedic product — it’s a thoughtfully formulated wellness blend powered by <b>25+ rare herbs from India and Malaysia.</b> Unlike conventional approaches that often manage only sugar
            levels, A5 supports your body’s natural ability to maintain balance and vitality — without chemicals or artificial additives. <br />
        </p>

        <p class="targets" style="">
            <!-- <b> -->
            ...
            ✅ Encourages natural wellness without dependency.<br />
            <!-- </b> -->
        </p>
        <!-- <br> -->
    ...
    <div class="imagesess" style="margin-top: 10px;">
        <img class="image-a5" style="width: 100%;" src="<?php echo base_url('/assets/images/H02.webp') ?>" loading="lazy" class="d-block w-100" alt="product-image" />
    </div>
</div>
...
if ($uri == '' || $uri == 'home') { // Adjust 'home' if your homepage route is different
?>
